...
namespace RTSEngine.RTSUserInterface
{
    ...
    public class UserInterfaceContainer : MonoBehaviour
    {
        ...
        [SerializeField] private UserInterfaceDefaultContainerManager containerManager;
        [SerializeField] private UserInterfaceContentComponent contentPrefab;
        

        public string LookupId { get => lookupId; set => lookupId = value; }
        public RectTransform Panel { get => panel; set => panel = value; }
        public UserInterfaceContentComponent ContentPrefab { get => contentPrefab; set => contentPrefab = value; }
        public UserInterfaceDefaultContainerManager ContainerManager { get => containerManager; set => containerManager = value; }
