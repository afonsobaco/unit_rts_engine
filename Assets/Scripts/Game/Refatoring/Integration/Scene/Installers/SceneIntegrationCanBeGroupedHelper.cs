...
{
    public class SceneIntegrationCanBeGroupedHelper : AbstractModifierHelper
    {
        [SerializeField] private List<SceneIntegrationObjectTypeEnum> types;
        ...
        {
            var gameType = GameUtils.GetComponent<SceneIntegrationObject, SceneIntegrationGameType>(element);
