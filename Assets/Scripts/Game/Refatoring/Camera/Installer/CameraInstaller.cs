...
namespace RTSEngine.Refactoring
{
    public class CameraInstaller : MonoInstaller
    {
        ...
        public override void InstallBindings()
        {
            ...
            Container.Bind<RTSCameraInterface>().AsSingle();
            ...
            Container.BindSignal<CameraMoveSignal>().ToMethod<RTSCameraManager>(x => x.OnCameraMoveSignal).FromResolve();
            Container.BindSignal<CameraPanSignal>().ToMethod<RTSCameraManager>(x => x.OnCameraPanSignal).FromResolve();
            Container.BindSignal<CameraZoomSignal>().ToMethod<RTSCameraManager>(x => x.OnCameraZoomSignal).FromResolve();
        }
